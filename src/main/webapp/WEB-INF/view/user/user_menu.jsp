                ...
                <div class="tickets__item ticket">
                    <div class="ticket__body">
                        ...
                        <div class="ticket__element">
                            <fmt:message key="user.mytickets.ticket.movietitle" bundle="${bundle}" var="umttickmt"/>${umttickmt}
                            : <c:out value="${ticket.filmName}"/>
                        </div>
                        <div class="ticket__element">
                            <fmt:message key="user.mytickets.ticket.date" bundle="${bundle}" var="umttickdate"/>${umttickdate}
                            : <c:out value="${ticket.dateSeance}"/>
                        </div>
                        <div class="ticket__element">
                            <fmt:message key="user.mytickets.ticket.time" bundle="${bundle}" var="umtticktime"/>${umtticktime}
                            : <c:out value="${ticket.timeSeance}"/>
                        </div>
                        <div class="ticket__element">
                            <fmt:message key="user.mytickets.ticket.place" bundle="${bundle}" var="umttickplace"/>${umttickplace}
